...
export default function HostChoose({
  roomState,
  clientWebsocket,
  lieList,
  playersChose,
  ...
  lieList.forEach((Player, lie) => {
    lieDisplay.push(
      <div key={lie} className={[styles.lie, sharedStyles.basic].join(" ")}>
        {lie}
      </div>
    );
  });
    ...
    >
      ...
      <div className={styles.container}>
        ...
        <div className={[styles.footer, sharedStyles.basic].join(" ")}>
          <h2>
            People Chosen : {amountPlayersChosen}/{amountOfPlayers}
          </h2>
